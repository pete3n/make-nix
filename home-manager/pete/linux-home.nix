...
let
  ...
  hyprlandEnabled = make_opts.isHomeAlone && builtins.elem "hyprland" make_opts.tags;

  hyprland-nixglIntel-wrapper = pkgs.writeShellScriptBin "Hyprland" ''
...
in
{
  ...
  home = {
    ...
    packages =
      lib.optional hyprlandEnabled hyprland-nixglIntel-wrapper
