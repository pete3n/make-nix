...
in {
  ...
  config = lib.mkIf cfg.enable {
    programs.wallpaper-scripts.wallpaperPath = lib.mkDefault (
      if config.programs.wallpaper-scripts.os == "darwin"
      then "/Users/${build_target.user}/wallpapers/default_background.png"
      else "/home/${build_target.user}/wallpapers/default_background.png"
    );
    home.packages = [
      wallpaperSetScript
      wallpaperCycleScript
