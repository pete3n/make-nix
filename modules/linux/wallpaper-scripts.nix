...
in {
  options.programs.wallpaper-scripts = {
    ...
    wallpaper = lib.mkOption {
      default = "/home/${build_target.user}/wallpapers/default_background.png";
      type = lib.types.path;
    ...
    home.packages = [
      (let
        wallpaperSetScript =
          ...
          */
          ''
            defaultWallpaperPath="/home/${build_target.user}/wallpapers/default_background.png"
      ...
      (pkgs.writeShellScriptBin "wallpaper-cycle"
        ...
        */
        ''
          ...
          current_wallpaper=$(${pkgs.swww}/bin/swww query | grep -oP 'image: \K.*' | head -n 1)
